...
from src.layers.activation import ReLU, Sigmoid, Softmax
...
def run_all_tests_gradient():
    ...
    all_errors += check_layer(Softmax(), np.random.randn(4, 5), "Softmax", check_input=True, n_checks=20, tolerance=1e-6)
